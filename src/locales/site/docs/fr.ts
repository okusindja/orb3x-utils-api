...
export const frDocsPages: DocsPageMap = {
  ...
  "nif-verification": {
    ...
    "sections": [
      {
        "id": "example-request",
        "title": "Requête d'exemple",
        "description": "Utilisez un NIF connu dans le chemin pour obtenir la charge utile active du contribuable.",
        "codes": [
          {
            "label": "Utilisation cURL",
            "language": "bash",
            "content": "curl -s \"https://utils.api.orb3x.com/api/nif/5000509442\""
          },
          {
            "label": "Utilisation Node.js",
            "language": "js",
