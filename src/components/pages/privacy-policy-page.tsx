...
export function PrivacyPolicyPage() {
  ...
  const { legal } = copy;
  const sectionCopy = legal.privacy;
        ...
        <PageIntro
          ...
          aside={
            <>
              ...
              <Card>
                <CardContent className="p-4">
                  <p className="text-xs font-semibold uppercase tracking-[0.18em] text-primary">{legal.scope}</p>
                  <p className="mt-3 text-base font-semibold tracking-tight text-foreground">{sectionCopy.scopeValue}</p>
                </CardContent>
              </Card>
              <Card>
                <CardContent className="p-4">
                  <p className="text-xs font-semibold uppercase tracking-[0.18em] text-primary">{legal.companySite}</p>
                  <p className="mt-3 text-sm leading-7 text-muted-foreground">{legal.companySiteDescription}</p>
                  <CompanyWebsiteLink
                    className="mt-3 inline-flex items-center gap-2 text-sm font-semibold text-primary"
                  >
                    {legal.companySiteCta}
