...
import { CodeSampleSwitcher, DataTable, Eyebrow } from '@/components/site-primitives';
              ...
              samples={[
                {
                  ...
                  language: 'bash',
                  code: docsQuickstartCurl,
                },
                {
                  label: copy.docsOverview.quickstartNodeLabel,
                  language: 'js',
                  code: docsQuickstartNode,
                },
              ]}
            />
          </div>
          ...
          <ScrollArea className="h-full">
            <div className="space-y-6 pl-2 pr-3">
              <div className="pb-6">
                ...
                <nav aria-label={copy.docsOverview.onPageLabel} className="mt-4 space-y-1.5">
