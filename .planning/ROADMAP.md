...
- [x] 04-01-PLAN.md — document tools (generate_invoice_pdf / generate_receipt_pdf / generate_contract_pdf) + pdfToolResult size guard + registry wiring (25 tools) + v1 shim verify [DOC-01..DOC-05]
**UI hint**: no
